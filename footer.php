		...
		<div id="sidebar" class="g gfl gc2 gmr0">
			<?php if ( in_category('3') ) { ?>
				...
				<p>To find the answer to your &ldquo;help&rdquo; request, just search in this box. (It&rsquo;ll only include posts and articles in the &ldquo;help&rdquo; category.)</p>
				<form action="http://blog.pearbudget.com/" id="help-search-form" method="get" role="search"><input type="hidden" name="cat" value="3"><input type="text" id="s" name="s" placeholder="Search the 'Help' section"></form>
			<?php } ?>
			<?php if ( is_single() ) : ?>
